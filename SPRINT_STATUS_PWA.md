...
Compliance note: this historical sprint log predates the public-demo guardrails.
The current public GitHub Pages deployment is synthetic only and disables patient
persistence, census, import/export, and patient-context handoff. Do not use the
public deployment for PHI, MRN fragments, real encounters, or handoff content.
...
| Public-demo census/persistence guardrails | src/components.jsx, src/app.jsx | Census, import/export, persistence, and patient-context handoff disabled on GitHub Pages |
| Hash routing under `/stroke/` | manifest start_url + app.jsx | `#/encounter` etc. |
| Quick-link bar (ChatGPT, OpenEvidence, UpToDate, Asta, Regional Facilities) | src/app.jsx:15943–15956 | Preserved verbatim |
...
All 11 phases shipped to production at  /stroke/.
