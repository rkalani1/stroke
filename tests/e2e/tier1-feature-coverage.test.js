...
describe('Tier 1: Feature Coverage (Features 1-19)', () => {
  ...
  describe('Feature 14: Evidence & Matcher Validator', () => {
    ...
    it('F14-T1.2: Evidence Atlas contains exactly 9 active trials and 249 completed trials', () => {
      expect(activeTrials.length).toBe(9);
      expect(completedTrials.length).toBe(249);
    });
    ...
    it('F14-T1.4: Evidence index exports 385 citations and 11 guideline recommendations', () => {
      expect(citations.length).toBe(385);
