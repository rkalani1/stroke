...
- **Evidence Atlas** sub-tab at `#/trials` with 71 completed/landmark trials, search, topic / certainty / evidence-type filters, and citation drilldown to PMID / DOI.
...
- **Pure-function matcher engine** (`src/evidence/matcher-engine.js`) with 100% coverage of 50 inclusion criteria + 16 exclusions across 10 active trials.
