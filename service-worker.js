/* v7.0 — service worker.
   ...
   - On activate: do NOT call self.clients.claim() immediately. Instead,
     broadcast {type:'sw-update-ready', version:'6.10.1'} to every open
   ...
   Cache-name bumped to stroke-cache-v6-10-1. Old caches are cleared on activate.
*/

const APP_VERSION = '6.10.1';
const CACHE_NAME  = 'stroke-cache-v6-10-1';
