/* v7.0 — service worker.
   ...
   - On activate: do NOT call self.clients.claim() immediately. Instead,
     broadcast {type:'sw-update-ready', version:'6.11.8'} to every open
   ...
   Cache-name bumped to stroke-cache-v6-11-8. Old caches are cleared on activate.
*/

const APP_VERSION = '6.11.8';
const CACHE_NAME  = 'stroke-cache-v6-11-8';
