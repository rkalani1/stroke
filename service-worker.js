/* v7.0 — service worker.
   ...
   - On activate: do NOT call self.clients.claim() immediately. Instead,
     broadcast {type:'sw-update-ready', version:'6.14.0'} to every open
   ...
   Cache-name bumped to stroke-cache-v6-14-0. Old caches are cleared on activate.
*/

const APP_VERSION = '6.14.0';
const CACHE_NAME  = 'stroke-cache-v6-14-0';
