...
const EDUCATION_MODULES = [
  ...
  },
  {
    ...
    purpose: 'Stepwise management protocol, osmotic therapy comparison, and supportive ICU care for cerebral edema.',
    actions: 'icp herniation cerebral edema brain swelling osmotherapy mannitol hypertonic saline hts evd midline shift herniation stepwise protocol',
    categories: ['pocket-card', 'printable', 'icu'],
    lastReviewed: '2026-05-30',
    references: [
  ...
  },
  {
    ...
    references: [
      ...
      },
      {
        ...
        citation: "Meretoja A, et al. Door-to-needle times for tissue plasminogen activator administration. Stroke. 2012.",
        pmid: "22933734"
      }
    ],
...
function renderSubModuleContent(moduleId, viewMode, onNavigate, copyToClipboard, addToast) {
  switch (moduleId) {
    ...
    case "reference-library":
      return viewMode === 'dashboard' ? (
        <ReferenceLibraryDashboard isTraineeMode={true} />
      ) : (
