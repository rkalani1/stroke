...
export const completedTrials = [
  ...
  t({
    ...
    topic: 'af-after-ich',
    diseaseArea: ['ich', 'af-after-ich', 'secondary-prevention'],
    population: { n: 412, ageRange: '75% ≥75', nihssRange: 'n/a', timeWindow: 'AF with prior spontaneous intracranial haemorrhage (pooled RCTs: SoSTART, APACHE-AF, NASPAF-ICH)', keyInclusion: ['Randomised in an anticoagulation-after-ICH trial'], keyExclusion: [] },
