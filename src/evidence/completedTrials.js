...
export const completedTrials = [
  ...
  t({
    ...
    fullName: 'Tenecteplase Before Thrombectomy at 4.5 to 24 Hours for Basilar Artery Occlusion (ATTENTION LATE)',
    topic: 'evt-basilar',
    diseaseArea: ['acute-ischemic-stroke', 'evt-basilar'],
    population: { n: 330, ageRange: '≥18', nihssRange: '≥10', timeWindow: '4.5-24 h', keyInclusion: ['Moderate to severe basilar-artery occlusion (NIHSS ≥10)', 'Admitted directly to EVT-capable centers'], keyExclusion: ['Prior IV thrombolysis before randomization'] },
    intervention: 'IV tenecteplase 0.25 mg/kg (max 25 mg) bolus + EVT',
    comparator: 'EVT alone',
    primaryEndpoint: { definition: 'Functional independence (mRS 0-2) at 90 d', timepoint: '90 d', result: 'Neutral: 30% (50/165, TNK+EVT) vs 30% (50/164, EVT alone)', effectSize: 'Adjusted rate ratio 0.92; risk difference -0.18%', confidenceInterval: '95% CI 0.67 to 1.25 (rate ratio); 95% CI -10.13% to 9.76% (risk difference)', pValue: 'Not significant (CIs cross the null)' },
    secondaryEndpoints: [],
    safetyFindings: { sich: '5% (8/165) vs 4% (6/164)', mortality: '40% (66/165) vs 43% (70/164) at 90 d', other: '' },
    imagingCriteria: 'CTA/MRA/DSA-confirmed basilar-artery occlusion; PC-ASPECTS ≥6 (CT) or ≥5 (MRI-DWI); 4.5-24 h from onset',
    applicabilityNotes: 'Multicenter (40 sites) open-label, blinded-endpoint (PROBE) RCT in China; patients admitted directly to EVT-capable centers.',
    limitations: 'Open-label treatment; conducted in China; applies to patients presenting directly to EVT-capable centers (does not address bridging in drip-and-ship transfers).',
    certainty: 'high',
    evidenceType: 'rct',
    citationIds: ['cit-attention-late-2026'],
    relatedActiveTrialIds: [],
    practiceImpact: 'In moderate-to-severe basilar-artery occlusion at 4.5-24 h presenting directly to EVT-capable centers, adding IV tenecteplase before thrombectomy did not improve 90-day functional outcomes over EVT alone.',
