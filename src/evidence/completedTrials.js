...
export const completedTrials = [
  ...
  t({
    ...
    topic: 'tnk-vs-alteplase',
    diseaseArea: ['acute-ischemic-stroke', 'tnk-vs-alteplase'],
    population: { n: 1430, ageRange: '≥18', nihssRange: 'NIHSS ≤25', timeWindow: '≤4.5 h', keyInclusion: ['IVT-eligible'], keyExclusion: ['EVT-intended in some sites'] },
  ...
  t({
    ...
    diseaseArea: ['secondary-prevention'],
  ...
  t({
    ...
    population: { n: 433, ageRange: 'Median 76', nihssRange: '', timeWindow: '≤24 h', keyInclusion: ['LVO treated with thrombectomy', 'eTICI 2b50-3 after EVT'], keyExclusion: [] },
    ...
    safetyFindings: { sich: '1.4% vs 0.5% (aOR 3.10, 0.32-30.0)', mortality: '12.1% vs 6.4%', other: 'Higher mortality signal warrants caution' },
  ...
  t({
    ...
    primaryEndpoint: { definition: 'Reperfusion / early recanalization + functional outcome', timepoint: '90 d', result: 'Improved reperfusion without a significant clinical-outcome difference', effectSize: '', confidenceInterval: '', pValue: '' },
  ...
  t({
    ...
    primaryEndpoint: { definition: 'Return to baseline function (mRS 0-1)', timepoint: '90 d', result: 'No benefit of tenecteplase vs standard of care', effectSize: '', confidenceInterval: '', pValue: 'NS' },
    secondaryEndpoints: [{ name: 'Mortality', result: 'Numerically higher with tenecteplase' }],
    safetyFindings: { sich: 'Low in both arms', mortality: 'Numerically higher with tenecteplase', other: '' },
