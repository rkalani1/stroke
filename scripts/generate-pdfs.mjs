...
async function main() {
  ...
  // ==========================================
  // 7. GENERATE SPONTANEOUS ICH PDF
  // ==========================================
  const ichAhaHtml = `
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8">
      <title>Spontaneous Intracerebral Hemorrhage</title>
      <style>
        @page { size: letter; margin: 0.15in; }
        body {
          font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif;
          margin: 0; padding: 0; color: #1a1b20; font-size: 8.5pt; line-height: 1.3; background: white;
          --ink: #1a1b20; --ink-soft: #3c3d47; --rule-soft: #f0eef3; --fill-soft: #f8f7fa;
          --red: #C62E2E; --red-soft: #fcebeb; --red-deep: #8E1E1E;
          --amber: #D9860B; --amber-soft: #fdf3e4; --amber-deep: #945B06;
          --teal: #18849E; --teal-soft: #e6f4f7; --teal-deep: #0F586B;
          --purple: #5B3B9C; --purple-soft: #f1edfa; --purple-deep: #3A2368;
        }
        .container {
          border: 2px solid var(--red); border-radius: 6px; overflow: hidden; display: flex; flex-direction: column; padding: 12px 18px; box-sizing: border-box;
        }
        h1 {
          font-size: 19pt; font-weight: 800; margin: 0 0 3px 0; text-align: center; color: var(--red-deep);
        }
        p.subtitle {
          font-size: 8.8pt; color: var(--ink-soft); margin: 0 0 10px 0; text-align: center; font-weight: 500;
        }
        .toast-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px; }
        .toast-card { border-radius: 8px; padding: 10px 12px; background: var(--fill-soft); border: 1px solid var(--rule-soft); }
        .toast-card.alert-red { border-left: 4px solid var(--red); background: linear-gradient(135deg, var(--red-soft) 0%, #ffffff 100%); }
        .toast-card.alert-orange { border-left: 4px solid var(--amber); background: linear-gradient(135deg, var(--amber-soft) 0%, #ffffff 100%); }
        .toast-card.primary { border-left: 4px solid var(--purple); background: linear-gradient(135deg, var(--purple-soft) 0%, #ffffff 100%); }
        .toast-card.secondary { border-left: 4px solid var(--teal); background: linear-gradient(135deg, var(--teal-soft) 0%, #ffffff 100%); }
        .toast-card h3 { font-size: 9.8pt; font-weight: 700; margin: 0 0 4px 0; }
        .toast-card.alert-red h3 { color: var(--red-deep); }
        .toast-card.alert-orange h3 { color: var(--amber-deep); }
        .toast-card.primary h3 { color: var(--purple-deep); }
        .toast-card.secondary h3 { color: var(--teal-deep); }
        .toast-card-list { margin: 4px 0 0 0; padding-left: 14px; font-size: 8.4pt; line-height: 1.4; color: var(--ink-soft); }
        .ref-citation {
          margin-top: 10px; font-size: 7pt; color: var(--ink-soft); border-top: 1px solid var(--rule-soft); padding-top: 6px; text-align: center; line-height: 1.3;
        }
      </style>
    </head>
    <body>
      <div class="container">
        <h1>Spontaneous Intracerebral Hemorrhage</h1>
        <p class="subtitle">AHA/ASA 2022 Guidelines for acute management of spontaneous ICH.</p>
        ...
        <div class="ref-citation">
          <strong>AHA/ASA 2022:</strong> Greenberg SM et al. <em>Stroke</em>. 2022;53:e282-e361. PMID: 35579034 | 
          <strong>STICH II:</strong> Mendelow AD et al. <em>Lancet</em>. 2013;382:397-408. PMID: 23726393 | 
          <strong>MISTIE III:</strong> Hanley DF et al. <em>Lancet</em>. 2019;393:1021-1032. PMID: 30739747
        </div>
      </div>
    </body>
    </html>
  ...
  await page.setContent(ichAhaHtml);
  await page.pdf({
    path: 'documents/references/Spontaneous ICH.pdf',
    format: 'letter',
    landscape: false,
    printBackground: true,
    margin: { top: '0.15in', bottom: '0.15in', left: '0.15in', right: '0.15in' }
  });
  console.log('Generated documents/references/Spontaneous ICH.pdf');
